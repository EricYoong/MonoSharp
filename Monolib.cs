namespace MonoSharp
{
    internal static class Mono
    {
        public static bool InitializeFunctions()
        {
            ...
            {
                Debug.WriteLine("Mono Init Funcs [OK]");
                return true;
            }
            Debug.WriteLine("Mono Init Funcs [FAIL]");
            return false;
        }
        ...
        private static class Monolib
        {
            ...
            public static bool init_functions()
            {
                ...
                if (iCount > 10000)
                {
                    Debug.WriteLine($"{nameof(iCount)} out of bounds!");
                    return false;
                }
                for (int i = 0; i < iCount; i++)
                {
                    ...
                    if (jCount > 1000)
                    {
                        Debug.WriteLine($"{nameof(jCount)} out of bounds!");
                        return false;
                    }
            ...
            public static mono_class_t find_class(string assembly_name, string class_name)
            {
                ...
                if (rowCount > 25000)
                {
                    Debug.WriteLine($"{nameof(rowCount)} out of bounds!");
                    return default;
                }
        ...
        public readonly struct mono_class_t
        {
            ...
            public readonly mono_method_t find_method(string method_name)
            {
                ...
                {
                    Debug.WriteLine($"{nameof(methodCount)} out of bounds!");
                    return default;
                }
            ...
            public readonly mono_class_field_t find_field(string field_name)
            {
                ...
                if (fieldCount > 10000)
                {
                    Debug.WriteLine($"{nameof(fieldCount)} out of bounds!");
                    return default;
                }
